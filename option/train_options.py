...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--fid_epoch', type=int, default=1, help='frequency of evaluating fid of generation')
        ...
        parser.add_argument('--nrf', type=int, default=64, help='# of routing filters in first conv layer')
        parser.add_argument('--dont_load_D', action='store_true')
        parser.add_argument('--lambda_feat', type=float, default=10.0, help='weight for feature matching loss')
        parser.add_argument('--lambda_vgg', type=float, default=10.0, help='weight for vgg loss')
        parser.add_argument('--lambda_w_recon', type=float, default=2.0, help='weight for w recon loss')
        parser.add_argument('--no_ganFeat_loss', action='store_true', help='if specified, do *not* use discriminator feature matching loss')
        parser.add_argument('--no_vgg_loss', action='store_true', help='if specified, do *not* use VGG feature matching loss')
        parser.add_argument('--gan_mode', type=str, default='hinge', help='(ls|original|hinge)')
        parser.add_argument('--netD', type=str, default='multiscale', help='(n_layers|multiscale|image|fpse)')
